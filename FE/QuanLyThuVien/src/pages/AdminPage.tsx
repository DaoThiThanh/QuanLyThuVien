        ...
        <header className="admin-header">
          ...
          <div className="admin-header-actions">
            ...
            <div className="admin-profile-btn">
              ...
              <span className="admin-username">{getUserName() || 'Quản trị viên'}</span>
            ...
            <>
              ...
              <div className="dashboard-stats">
                <div className="stat-card">
                  ...
                  <div className="stat-value">{loading ? '...' : stats?.totalReaders}</div>
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-value">{loading ? '...' : 156}</div>
                  <div className="stat-trend trend-up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-value">{loading ? '...' : `${(stats?.totalRevenue || 0).toLocaleString()} ₫`}</div>
                  <div className="stat-trend trend-up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
                    <span>+15.2%</span>
                  </div>
                ...
                <div className="stat-card">
                  <div className="stat-header">
                    <span>Hệ Thống</span>
                    <div className="stat-icon" style={{color: '#aa3bff', backgroundColor: 'rgba(170, 59, 255, 0.1)'}}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                    </div>
                  </div>
                  <div className="stat-value" style={{fontSize: '28px'}}>{loading ? '...' : stats?.systemStatus}</div>
                  <div className="stat-trend trend-up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
              ...
              <div className="admin-dashboard-grid">
                ...
                <div className="admin-section">
                  <div className="section-header">
                    <h2 className="section-title">Nhân viên trực tuyến</h2>
                    <Link to="/admin/users" className="view-all-link">Xem tất cả</Link>
                  </div>
                            ...
                            <tr key={user.id}>
                              <td>
                                <div className="user-info">
                                  <div className="user-avatar" style={{backgroundColor: user.vaiTro === 1 ? 'rgba(170, 59, 255, 0.1)' : '#10b98120', color: user.vaiTro === 1 ? 'var(--accent)' : '#10b981', fontSize: '14px', width: '32px', height: '32px'}}>
                                    {user.hoTen.charAt(0).toUpperCase()}
                                  </div>
                                  <div className="user-details">
                                    <span className="user-name" style={{fontSize: '14px'}}>{user.hoTen}</span>
                                  </div>
                                </div>
                              </td>
                              <td>
                                <span className="status-badge" style={{padding: '4px 10px', fontSize: '12px', backgroundColor: user.vaiTro === 1 ? '#f5f3ff' : '#ecfdf5', color: user.vaiTro === 1 ? '#7c3aed' : '#10b981'}}>
          ...
          {activeTab === 'users' && (
            <div className="admin-section">
              <div className="section-header">
                ...
                <button className="section-action">+ Thêm Độc Giả</button>
              </div>
              <div className="table-responsive">
                <table className="admin-table">
                  <thead>
                    ...
                    {users.filter(u => u.vaiTro === 3).length > 0 ? (
                      users.filter(u => u.vaiTro === 3).map((user) => (
                        <tr key={user.id}>
                          ...
                          <td>
                             <button className="btn-icon view"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button>
                          </td>
                        </tr>
                      ))
                    ) : (
