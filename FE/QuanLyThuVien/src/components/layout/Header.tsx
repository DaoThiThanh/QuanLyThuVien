    ...
    <header className={styles['library-header']}>
      <div className={styles['header-container']}>
        ...
        <div className={styles['header-logo']} onClick={() => navigate('/')}>
          ...
          <span className={styles['logo-text']}>LibraryHub</span>
        </div>

        {/* Navigation Section */}
        <nav className={styles['header-nav']}>
          <NavLink to="/" className={({ isActive }) => isActive ? `${styles['nav-item']} ${styles['active']}` : styles['nav-item']} end>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg>
            Trang chủ
          </NavLink>
          <NavLink to="/books" className={({ isActive }) => isActive ? `${styles['nav-item']} ${styles['active']}` : styles['nav-item']}>
          ...
          {isLoggedIn && (
            <>
              <NavLink to="/borrowed-books" className={({ isActive }) => isActive ? `${styles['nav-item']} ${styles['active']}` : styles['nav-item']}>
