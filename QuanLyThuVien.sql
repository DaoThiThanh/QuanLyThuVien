...
CREATE TABLE ThamSoQuyDinh (
    ...
    PhiPhatHongNhe DECIMAL(10, 2) NOT NULL DEFAULT 20000,
    PhiPhatHongNang DECIMAL(10, 2) NOT NULL DEFAULT 50000,
    PhiPhatMatSach DECIMAL(10, 2) NOT NULL DEFAULT 100000,
